...
public class testset5_1_22b
{
    public void foo_barSink(String data ) throws Throwable
    {
        if (testset5_1_22a.foo_barPublicStatic)
        {
    ...
    {
        if (testset5_1_22a.cwe_bar1PublicStatic)
        {
    ...
    {
        if (testset5_1_22a.cwe_bar2PublicStatic)
        {
            Connection dbConnection = null;
            PreparedStatement sqlStatement = null;
            try
    ...
    {
        if (testset5_1_22a.cwe_fooPublicStatic)
        {
            Connection dbConnection = null;
            Statement sqlStatement = null;
            try
