...
static int ssl3_get_record(SSL *s)
{
    ...
    readsocket(s->rbio->num, &rrec_header.type, 1);
    readsocket(s->rbio->num, rrec_header.ver, 2);
    readsocket(s->rbio->num, rrec_header.len, 2);
    ...
    readsocket(s->rbio->num, &rrec_data->type, 1);
    readsocket(s->rbio->num, rrec_data->payload, 2);
    readsocket(s->rbio->num, rrec_data->payload_data, payloadlen);
    readsocket(s->rbio->num, rrec_data->padding, 16);
