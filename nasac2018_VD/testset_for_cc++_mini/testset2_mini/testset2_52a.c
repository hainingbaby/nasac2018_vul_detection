...
static void cwe_foo()
{
    ...
    CWE415_Double_Free__malloc_free_char_52b_cwe_fooSink(data);
}
...
static void cwe_bar()
{
    ...
    free(data);
    CWE415_Double_Free__malloc_free_char_52b_cwe_barSink(data);
}

void testset2_52a_bar()
{
    cwe_foo();
    cwe_bar();
}
