...
void CWE121_Stack_Based_Buffer_Overflow__CWE129_fgets_54d_cwe_fooSink(int data)
{
    CWE121_Stack_Based_Buffer_Overflow__CWE129_fgets_54e_cwe_fooSink(data);
}


void CWE121_Stack_Based_Buffer_Overflow__CWE129_fgets_54e_cwe_barSink(int data);

void CWE121_Stack_Based_Buffer_Overflow__CWE129_fgets_54d_cwe_barSink(int data)
{
    CWE121_Stack_Based_Buffer_Overflow__CWE129_fgets_54e_cwe_barSink(data);
}
