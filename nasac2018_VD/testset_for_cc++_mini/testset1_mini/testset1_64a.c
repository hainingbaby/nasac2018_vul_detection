...
static void cwe_foo()
{
    ...
    data = 7;
    CWE121_Stack_Based_Buffer_Overflow__CWE129_fgets_64b_cwe_fooSink(&data);
}
...
static void cwe_bar()
{
    ...
    CWE121_Stack_Based_Buffer_Overflow__CWE129_fgets_64b_cwe_barSink(&data);
}

void testset1_64a_bar()
{
    cwe_foo();
    cwe_bar();
}
